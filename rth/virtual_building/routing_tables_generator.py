...
class RoutingTablesGenerator:
    ...
    ##
    #  @param network_creator_instance The NetworkCreator instance
    #  @param subnets The subnetworks
    #  @param routers The routers
    #  @param links The links
    #  @param hops The hops (paths) generated by the Ants system
    ...
    #  If the router is connected to the subnetwork, return its IP
    #  @param instance_ The subnetwork instance
    #  @param provided The UID of the provided router
    @staticmethod
    ...
    #  @param subnets The subnetworks list
    ...
    #  @param router_id The UID of the router
